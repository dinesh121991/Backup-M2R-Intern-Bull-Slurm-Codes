			...
			uint16_t *cpu_cnt, uint16_t cr_type)
{
	...
	info("L-Entered eval_nodes_topo=>job_ptr->req_switch:%d,job_ptr->wait4switch:%d,job_ptr->wait4switch_start:%d,job_ptr->best_switch:%d",
	     job_ptr->req_switch,job_ptr->wait4switch,job_ptr->wait4switch_start,job_ptr->best_switch);
