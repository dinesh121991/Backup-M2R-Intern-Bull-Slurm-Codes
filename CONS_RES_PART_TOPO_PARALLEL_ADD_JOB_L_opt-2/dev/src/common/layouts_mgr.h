 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
int layouts_multi_entity_set_kv(char* layout, List entity,
 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
int layouts_multi_entity_get_kv(char* layout, List entity,
			  char* key, void *value,int count,size_t size_of_value);
