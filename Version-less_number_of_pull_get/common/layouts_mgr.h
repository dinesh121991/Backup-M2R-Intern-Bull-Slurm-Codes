...
/*
 * layouts_multi_entity_set_kv - update multiple entities with a new value 
 *		for a particular key in the targeted layout.
 *
 * The input key_type will force the call to check types consistency between
 * the requester and the underlying keyspec associated with the key. To skip
 * that check the caller will have to pass a 0 value.
...
/*int layouts_multi_entity_set_kv_uint32(char* layout, List entity,
			  char* key, void *value,size_t size_of_value);*/
int layouts_multi_entity_set_kv_uint32(char* layout, hostlist_t entity,
			  char* key, void *value);

/*
 * layouts_multi_entity_get_kv - update multiple entities with a new value 
 *		for a particular key in the targeted layout.
 *
 * The input key_type will force the call to check types consistency between
 * the requester and the underlying keyspec associated with the key. To skip
...
int layouts_multi_entity_get_kv(char* layout, hostlist_t entity,
			  char* key, void *value,layouts_keydef_types_t key_type);
/*
 * layouts_multi_entity_set_k_multi_v - update multiple entities with a new value 
 *		for a particular key in the targeted layout.
 *
 * The input key_type will force the call to check types consistency between
 * the requester and the underlying keyspec associated with the key. To skip
 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
int layouts_multi_entity_set_k_multi_v_uint32(char* layout, List entity,
			  char* key,void *value);

/*
 * layouts_entity_parallel_set_kv - update an entity with a new value for a particular
 *        key in the targeted layout without lock so it can be acccessed the entity 
 * individually by using threads(pthread).
 *
 * The input key_type will force the call to check types consistency between
 * the requester and the underlying keyspec associated with the key. To skip
 * that check the caller will have to pass a 0 value.
 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
int layouts_entity_parallel_set_kv(char* layout, char* entity,
			  char* key, void* value,
			  layouts_keydef_types_t key_type);
...
/*
 * layouts_entity_parallel_get_kv - get the value associated with a key of an entity
 *        in a particular layout.
 *
 * The input key_type will force the call to check types consistency between
 * the requester and the underlying keyspec associated with the key. To skip
 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
int layouts_entity_parallel_get_kv(char* layout, char* entity,
			  char* key, void* value,
			  layouts_keydef_types_t key_type);
...
/*
 * layouts_entity_get_kv_unit32 - combination of 
 * layouts_entity_get_kv to retrieve uint32_t type custom and fast implementation.
 *
 * The input key_type will force the call to check types consistency between
 * the requester and the underlying keyspec associated with the key. To skip
 * that check the caller will have to pass a 0 value.
 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
int layouts_entity_get_kv_uint32(char* layout, char* entity,
			      char* key, void* value);

/*
 * layouts_entity_get_kv_unit16 - combination of 
 * layouts_entity_get_kv to retrieve uint32_t type custom and fast implementation.
 *
 * The input key_type will force the call to check types consistency between
 * the requester and the underlying keyspec associated with the key. To skip
 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
int layouts_entity_get_kv_uint16(char* layout, char* entity,
			      char* key, void* value);
 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
int layouts_entity_set_kv_uint32(char* layout, char* entity,
			      char* key, void* value);
 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
int layouts_entity_set_kv_uint16(char* layout, char* entity,
			      char* key, void* value);

/*
 * layouts_entity_get_kv_unit32 - combination of layouts_entity_pull_kv and
 *        layouts_entity_get_kv to retrieve the up-to-date value of a particular
 *        entity key in the targeted layout.
 *
 * The input key_type will force the call to check types consistency between
 ...
 * Return SLURM_SUCCES or SLURM_ERROR in case of failure
 */
/*int layouts_entity_set_kv_unit32(char* layout, char* entity,
			      char* key, void* value);*/
...
int layouts_entity_set_mkv(char* layout, char* entity,
			   char* keys, void* value, size_t length,
			   layouts_keydef_types_t key_type);
...
int layouts_entity_pull_mkv(char* l, char* e, char* keys);
