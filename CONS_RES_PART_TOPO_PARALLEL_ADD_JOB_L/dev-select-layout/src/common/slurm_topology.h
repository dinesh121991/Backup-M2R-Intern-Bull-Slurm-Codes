...
extern int root_switch_index;
extern int leaf_switch_cnt;
extern int *leaf_switch_index;
extern int **level_switch_index;
extern int *level_switch_count;
extern int switch_levels_max;
