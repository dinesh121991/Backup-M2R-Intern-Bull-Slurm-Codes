...
s_p_options_t entity_options[] = {
	...
	{"AvailableCpusCount",S_P_UINT32},
	//{"SwitchesRequiredCount",S_P_UINT32},
	
	/* Parents aggregated keys */
	// topology based configuration
	
	{"AvailableSumNodesInLevel0", S_P_UINT32},  
	{"AvailableSumCpusInLevel0",S_P_UINT32}, 
	//{"SwitchesRequiredInLevel0",S_P_UINT32},
	
	{"AvailableSumNodesInLevel1", S_P_UINT32}, 
	{"AvailableSumCpusInLevel1",S_P_UINT32},
	//{"SwitchesRequiredInLevel1",S_P_UINT32},
	
	{"AvailableSumNodesInLevel2", S_P_UINT32},
	{"AvailableSumCpusInLevel2",S_P_UINT32},
	//{"SwitchesRequiredInLevel2",S_P_UINT32},
	
	{"AvailableSumNodesInLevel3", S_P_UINT32},
	{"AvailableSumCpusInLevel3",S_P_UINT32},
	//{"SwitchesRequiredInLevel3",S_P_UINT32},
...
const layouts_keyspec_t keyspec[] = {
	...
	{"AvailableCpusCount",L_T_UINT32},
	//{"SwitchesRequiredCount",L_T_UINT32},

	/* Parents aggregated keys */
	// topology based configuration
	{"AvailableSumNodesInLevel0", L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AvailableNodeCount"},
	{"AvailableSumCpusInLevel0",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AvailableCpusCount"},
	//{"SwitchesRequiredInLevel0",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "SwitchesRequiredCount"},
	
	{"AvailableSumNodesInLevel1", L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AvailableSumNodesInLevel0"}, 
	{"AvailableSumCpusInLevel1",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AvailableSumCpusInLevel0"},
	//{"SwitchesRequiredInLevel1",L_T_UINT32,KEYSPEC_UPDATE_CHILDREN_SUM,"SwitchesRequiredInLevel0"},
	
	{"AvailableSumNodesInLevel2", L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AvailableSumNodesInLevel1"},
	{"AvailableSumCpusInLevel2",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AvailableSumCpusInLevel1"},
	//{"SwitchesRequiredInLevel2",L_T_UINT32,KEYSPEC_UPDATE_CHILDREN_SUM,"SwitchesRequiredInLevel1"},
	
	{"AvailableSumNodesInLevel3", L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AvailableSumNodesInLevel2"},
	{"AvailableSumCpusInLevel3",L_T_UINT32, KEYSPEC_UPDATE_CHILDREN_SUM, "AvailableSumCpusInLevel2"},
	//{"SwitchesRequiredInLevel3",L_T_UINT32,KEYSPEC_UPDATE_CHILDREN_SUM,"SwitchesRequiredInLevel2"},
